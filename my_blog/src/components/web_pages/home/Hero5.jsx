...
const Hero5 = () => {
  return (
    <section
      ...
      <div className="z-10 relative items-center my-10 max-w-7xl sm:px-6 mx-auto lg:px-8 flex gap-3 lg:flex-justify lg:flex flex-col lg:flex-row">
        <div className="sm:text-center lg:text-left">
          ...
          {/* Button Section */}
            ...
            <a href='#' className=' flex justify-center items-center font-bold border-gray-400 text-white py-2 xs: px-12 rounded-tr-3xl rounded-bl-3xl bg-indigo-800'>Reservation</a>
            <a href='#' className='border flex justify-center items-center font-bold border-indigo-400 text-indigo-700 dark:text-indigo-100 py-2 xs: px-12 rounded-md  '>
              Notre Guide Gratuit
            </a>
