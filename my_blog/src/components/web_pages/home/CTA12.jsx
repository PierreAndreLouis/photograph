    ...
    return (
        <div
           ...
           justify-center items-center absolute inset-0 z-[3]'>
                <h1 className='text-white text-center  text-4xl font-bold'>Pourquoi  stratégies <span style={{ color: '#7b9bff' }}> marketing</span>?</h1>
...
nous offrons des solutions sur mesure qui répondent à vos besoins spécifiques, avec un soutien constant pour garantir votre succès. Nous faisons en sorte que chaque stratégie soit efficace et adaptée à vos objectifs.                </p>
                <Link to="/reservation" style={{ border: '2px solid #7b9bff', color: '#7b9bff' }} className=' rounded-md mt-12 p-3 px-8 text-white font-bold text-md'>Prend Rendez-vous</Link>
            </div>
