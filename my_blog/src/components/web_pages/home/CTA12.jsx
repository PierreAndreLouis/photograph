...
export default function CTA12() {
    return (
        <div
            style={{ backgroundImage: 'url(https://www.findbanquet.com/blog/wp-content/uploads/2024/06/photographers.jpg)', backgroundPosition: "right" }}
            className='object-right   relative py-72 bg-fixed bg-cover bg-center'>

            <div className='absolute inset-0 z-[2]' style={{ backgroundColor: 'rgba(0, 0, 0, 0.70)' }}></div>


            <div className='flex flex-col px-2 
           justify-center items-center absolute inset-0 z-[3]'>
                <h1 className='text-white text-4xl text-center font-bold lg:text-5xl max-w-4xl'>Avez vous besoin d'une seance <span className='text-sky-400'> Photographie </span>?</h1>
