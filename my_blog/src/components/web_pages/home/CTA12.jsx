...
export default function CTA12() {
    return (
        <div
            ...
            <div className='absolute inset-0 z-[2] bg-sky-100/90 dark:bg-gray-900/90'></div>
            
            <div className='flex flex-col px-2 
           justify-center items-center absolute inset-0 z-[3]'>
                <h1 className='text-black dark:text-gray-100  text-3xl  sm:text-3xl text-center font-bold lg:text-4xl max-w-4xl leading-9'>
                    Vous souhaitez être accompagné
                    <span className='text-sky-400'> dans la recherche de solutions? </span>?</h1>
                <p className='text-center text-gray-900 dark:text-gray-100 mt-10 text-md leading-6 lg:text-md max-w-3xl'>
                ...
                <Link
                    to='/reservation'    
                    className='border border-sky-500 text-sky-500 rounded-md mt-12 p-3 px-8 font-bold text-lg'>
