                ...
                <div className="justify-between items-center gap-12 md:flex">
                    ...
                    <div id="mc_embed_signup" className="flex-1 mt-6 md:mt-0">
                        <form
                            ...
                            target="_blank"
                            className="validate flex items-center gap-x-3 md:justify-end">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className="required email w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border focus:border-sky-600 shadow-sm rounded-lg"
                                />
                            </div>
                            <button
                                type="submit"
                                ...
                                className="button block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-sky-600 hover:bg-sky-500 active:bg-sky-700 active:shadow-none rounded-lg shadow">
                                Subscribe
                            </button>
                        </form>
                    </div>
