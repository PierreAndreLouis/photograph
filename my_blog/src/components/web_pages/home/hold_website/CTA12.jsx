    ...
    return (
        <div
           ...
           justify-center items-center absolute inset-0 z-[3]'>
                <h1 className='text-white text-5xl text-center font-bold lg:text-5xl max-w-4xl'>Avez vous besoin d'une seance <span className='text-sky-400'> Photographie </span>?</h1>
