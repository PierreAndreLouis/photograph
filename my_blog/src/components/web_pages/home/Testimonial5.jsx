        ...
        <div>
            <section className="bg-white dark:bg-gray-900">
                <div className="max-w-6xl px-6 py-20 mx-auto">
                    <p className="text-center text-xl font-medium text-gray-500">Testimonials</p>
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mt-6 md:justify-start">
                                    <button
                                        ...
                                        title="left arrow"
                                        className="p-2 text-white transition-colors duration-300 border rounded-full rtl:-scale-x-100 hover:bg-sky-400"
                                    >
                                    ...
                                    <button
                                        ...
                                        title="right arrow"
                                        className="p-2 text-white transition-colors duration-300 border rounded-full rtl:-scale-x-100 md:mx-6 hover:bg-sky-400"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
